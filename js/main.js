...
function filterCourses() {
  ...
  courses.forEach(course => {
    ...
    const items = course.querySelectorAll('ul li');
    ...
    if ((categoryFilter === 'all' || category === categoryFilter) && (title.includes(searchInput) || itemMatches)) {
